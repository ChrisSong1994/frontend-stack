...
- [Babel 用户手册](#babel-用户手册)
- [目录](#目录)
- [介绍](#介绍)
- [安装 Babel](#安装-babel)
  - [`babel-cli`](#babel-cli)
    - [在项目内运行 Babel CLI](#在项目内运行-babel-cli)
...
- [配置 Babel（进阶）](#配置-babel进阶)
  - [手动指定插件](#手动指定插件)
  - [插件选项](#插件选项)
  - [基于环境自定义 Babel](#基于环境自定义-babel)
  - [制作你自己的预设（preset）](#制作你自己的预设preset)
- [Babel 和其他工具](#babel-和其他工具)
  - [静态分析工具](#静态分析工具)
    - [语法检查（Linting）](#语法检查linting)
    - [代码风格](#代码风格)
    - [文档](#文档)
  - [框架](#框架)
    - [React](#react)
  - [文本编辑器和 IDEs（集成开发环境）](#文本编辑器和-ides集成开发环境)
- [Babel 支持](#babel-支持)
  - [Babel 论坛](#babel-论坛)
  - [Babel 聊天](#babel-聊天)
  - [Babel 问题](#babel-问题)
